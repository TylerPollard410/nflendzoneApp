...
##
golem::fill_desc(
	pkg_name = "nflendzoneApp", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
	pkg_title = "NFL EndZone Analytics Shiny Dashboard", # What the Package Does (One Line, Title Case, No Period)
	pkg_description = "Interactive Shiny dashboard for NFL team rankings, historical performance and Bayesian betting predictions (built with nflverse & cmdstanr).", # What the package does (one paragraph).
	authors = person(
	...
	repo_url = "https://github.com/TylerPollard410/nflendzoneApp", # The URL of the GitHub repo (optional),
